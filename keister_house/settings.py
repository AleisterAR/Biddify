"""
Django settings for keister_house project.
...
SECRET_KEY = 'django-insecure-+6!59woz#p_2ubnbk05p7()pr3fpgzao7y9j_hkqkx-1^*l0mv'
...
STRIPE_WEBHOOK_SECRET= "whsec_df5b135f28b96b26a9816f074137ce7575c5a39b0cf99dc2ca03b7083a9898a7"
...
ROOT_URLCONF = 'keister_house.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bid.context_processors.notification_processor',
            ],
        },
    },
]
...
STATICFILES_DIRS = [
    BASE_DIR / "public",
    ("common", os.path.join(BASE_DIR, COMMON_FOLDER)),
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'localstorage')
MEDIA_URL = '/localstorage/'
